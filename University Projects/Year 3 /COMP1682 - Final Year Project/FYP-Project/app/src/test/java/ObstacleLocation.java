...
public class ObstacleLocation {
     ...
     */
        public Point getObstacleCoordinateTest (int GraphSize, int distance , Point currentLoc, double direct ){

                Point currentLocation = currentLoc;
                double directionRaw = direct;
                double direction;
                if (directionRaw < 0) {
