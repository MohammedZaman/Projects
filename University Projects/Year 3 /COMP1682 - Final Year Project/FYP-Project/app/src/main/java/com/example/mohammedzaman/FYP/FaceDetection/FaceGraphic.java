...
//        }
        ...
        canvas.drawText(String.valueOf(dis.calculateDistanceLogRegresRaw(face.getWidth())) , canvas.getWidth() / 2, canvas.getHeight() + lineHalf, mIdPaint);
